 ...
 *
 * @covers \PhpUnitGen\Core\Generators\Tests\Laravel\Channel\ChannelTestGenerator
 */
class ChannelTestGeneratorTest extends TestCase
{
    ...
    public function testIsTestable(bool $expected, bool $automatic, ReflectionMethod $method): void
    {
        ...
        $testGenerator = new ChannelTestGenerator();
    ...
    public static function isTestableDataProvider(): array
    {
        ...
        $joinMethod = Mockery::mock(ReflectionMethod::class);
